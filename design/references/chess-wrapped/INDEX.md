...
| Path | Character |
|------|-----------|
| `design/mobile/chess app/ui/` | Playfair + IBM Plex, crimson neo-brutal `filter-rect`, bg `#0a0a0f` |
| `design/mobile/chess app/Enhance App Visuals (2)/` | Fraunces + JetBrains Mono, softer loss `#f87171`, ink `#ededf5` |
| `design/mobile/chess app/Enhance App Visuals/` | Vite cache / earlier unpack |
| `design/mobile/chess app/Enhance App Visuals.zip` | Archive of Enhance prototype |
...
- **Alpha pieces** (Eric Bentzen via Lichess): personal non-commercial — see `assets/chess-wrapped/chess_set/LICENSE.md`
