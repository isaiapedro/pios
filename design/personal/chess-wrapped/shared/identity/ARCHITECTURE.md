...
|---------|------------------------------|---------------|
| Colors, spacing, radius, type | `mobile/src/theme.ts` | `../../mobile/ui-kit/theme.ts` |
| Primitive components | `mobile/src/components/ui.tsx` | `../../mobile/ui-kit/README.md` |
| Navigation chrome | `mobile/src/navigation/TabNavigator.tsx` | `../../mobile/implementation/README.md` |
| Editorial / analog language | `chess/visual_identity.md` | `../references/visual_identity.md` |
| Figma exploration tokens | `mobile/prototypes/figma-make/src/index.css` | `../references/INDEX.md` |
