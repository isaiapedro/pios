...
```bash
./services/planner/implementation/databases/init_pios.sh
```
...
psql postgresql://postgres:password@localhost:5432/pios \
  -f services/planner/implementation/databases/pg_init.sql
```

From `services/planner/implementation/databases/`:
...
```bash
./services/planner/implementation/databases/reset_planner_data.sh
```
